 ...
 */
public class LoadingBallView extends RelativeLayout {
    Context context;
    //左边跳动的小球
    ImageView ball_left;
    //右边跳动的小球
    ...
    public LoadingBallView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);

    }

    public LoadingBallView(Context context, AttributeSet attrs, int defStyleAttr) {
