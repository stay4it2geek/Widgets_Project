...
public class ImageViewpagerView extends RelativeLayout {
    ...
    private void setLayout(Context context) {
        ...
        //设置内边距
        pointContainerRl.setPadding(0, 10, 0, DisplayUtil.dip2Px(getContext(),8));
        //设定指示器容器布局及位置
    ...
    private class FlyPageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (isBanner) {
                ...
                imageView.setImageUrlOfBanner(mImageUrls.get(toRealPosition(position)), ApiManager.getInstance(getContext()).getImageLoader(), false);
                container.addView(imageView);
                return imageView;

            } else {

                DetailNetworkImage imageView = new DetailNetworkImage(getContext());

                imageView.setImageUrlOfDetail(mImageUrls.get(toRealPosition(position)), ApiManager.getInstance(getContext()).getImageLoader());
