 ...
 */
public class RecomondeCategoryImage extends RelativeLayout {
    ...
    public RecomondeCategoryImage(Context context) {
        super(context);
        init(context);

    }

    public RecomondeCategoryImage(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);

    }

    public RecomondeCategoryImage(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        View layout = inflater.inflate(R.layout.customview_layout_recommond_catagory_image, this);
        ...
        loadfail_rl = (RelativeLayout) layout.findViewById(R.id.cate_loadfail_rl);
