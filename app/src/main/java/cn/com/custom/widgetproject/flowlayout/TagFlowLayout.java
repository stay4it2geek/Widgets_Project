package cn.com.custom.widgetproject.flowlayout;
 ...
 *
 */
public class TagFlowLayout extends FlowLayout implements HotWordListAdapter.OnDataChangedListener
{
    private HotWordListAdapter mTagAdapter;
    ...
    public void setAdapter(HotWordListAdapter adapter)
    {
        mTagAdapter = adapter;
    ...
    {
        removeAllViews();
        HotWordListAdapter adapter = mTagAdapter;
...
//            lp.rightMargin = clp.rightMargin;
    ...
    public HotWordListAdapter getAdapter()
    {
        return mTagAdapter;
    }
